  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between relative z-10">
        <div className="px-12 lg:px-16 xl:px-20 xl:pt-6 2xl:pt-12"> 
          <div className="max-w-md">
            <h1 className="text-[32px] md:text-[22px] xl:text-[26px] 2xl:text-[32px] font-bold text-[#474653] mb-4">
              Welcome Back
            </h1>
            <p className="text-gray-600 xl:text-[16px] 2xl:text-[20px] font-semibold leading-relaxed">
              Sign in to your Truenote account to order your favorite coffee,
              manage your orders, and explore fresh beans.
            </p>
            <div className="flex justify-center">
              <img src={cup_image} alt="" className="md:w-40 xl:w-50 2xl:w-60" />
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex justify-center lg:justify-end px-5 sm:px-10 lg:pr-20 py-8 lg:py-10 relative z-10">
        <div className="w-full max-w-md">
          ...
          {/* Mobile-only heading — replaces the hidden left column */}
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-start flex-wrap gap-2">
                ...
                {/* <Link
                  to="/forgot-password"
                  className="text-sm text-[#135CC1] hover:underline"
                >
                  Forgot Password?
                </Link> */}
              </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link to="/register" className="text-[#135CC1] font-medium hover:underline">
                Sign Up
              </Link>
            </p>
          </div>
